...
export const HERO = {
  ...
  headlineAccent: "Terstruktur & Terarah.",
  subtitle:
    ...
    plans: [
      {
        ...
        features: [
          "Market Outlook",
          "Akses Discord Sinyal Crypto",
          "Akses Voice Chat Discord",
          "Akses Crypto Live Trading",
          "Konsultasi Gratis",
        ],
        ctaLink: "/register",
      },
    ...
    plans: [
      {
        ...
        features: [
          "Market Outlook",
          "Akses Discord Sinyal Forex & Crypto",
          "Akses Voice Chat Discord",
...
export const TESTIMONIALS = [
  ...
  {
    name: "Dewi S.",
    duration: "Forex Trader • 1 tahun",
    text: "Market outlook-nya membantu banget buat belajar. Gua yang kerja kantoran bisa tetap belajar trading tanpa harus mantau chart seharian.",
    rating: 5,
  },
  {
    name: "Budi W.",
    duration: "Crypto Trader • 4 bulan",
    text: "Moonbag Live-nya informatif dan mentornya sabar banget jelasin. Komunitas juga aktif, jadi belajarnya ga sendirian. Sekarang udah lebih percaya diri buat analisa sendiri.",
    rating: 4,
  },
  {
    name: "Rina M.",
    duration: "Cuantroopers • 8 bulan",
    text: "Udah coba beberapa kursus trading lain, tapi Cuanterus yang paling praktikal. Materinya langsung bisa dipahami dan diterapkan. Worth it banget.",
    rating: 5,
  },
];
