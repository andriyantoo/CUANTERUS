          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mt-6">
                <a href="http://instagram.com/andriyantoo" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl flex items-center justify-center transition-colors hover:bg-[#E1306C]/20" style={{ background: `${LIME}10`, color: TEXT_SEC }}>
                ...
                <a href="https://x.com/andricuanterus" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl flex items-center justify-center transition-colors hover:bg-white/10" style={{ background: `${LIME}10`, color: TEXT_SEC }}>
